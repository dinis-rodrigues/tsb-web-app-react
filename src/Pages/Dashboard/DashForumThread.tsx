        ...
        <div className="card-header">
          ...
          <div className="media flex-wrap w-100 align-items-center">
            ...
            <div className="media-body ml-3">
              <Link to="userProfile">{threadInformation.createdByName}</Link>
              {" · "}
              {USER && usersMetadata && usersMetadata[USER.id].pinfo.position}
            ...
            <div className="text-muted small ml-3">
              <div>
                <strong>
                  {usersMetadata[threadInformation.createdBy].pinfo.department}
                </strong>
              </div>
              <div className="float-right">
                Joined in{" "}
                <strong>
                  {usersMetadata[threadInformation.createdBy].pinfo.joinedIn}
                </strong>
              </div>
            </div>
          </div>
